...
function settings(over: Partial<SettingsRow> = {}): SettingsRow {
  return {
    ...
    scraper_region: null, scraper_min_score: null, scraper_max_pairs: null, scraper_per_pair: null, verzug_base_rate: 1.27, datev_revenue_account: null, datev_debitor_account: null, datev_bank_account: null,
    ...over,
  }
}
