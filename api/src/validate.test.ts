...
function settings(over: Partial<SettingsRow> = {}): SettingsRow {
  return {
    ...
    datev_revenue_account: null, datev_debitor_account: null, datev_bank_account: null, ...over,
  }
}
...
function invoice(over: Partial<FullDocument> = {}): FullDocument {
  ...
  return {
    ...
    client_type: 'geschaeft', client_vat_id: null, corrects_document_id: null,
    created_at: '', updated_at: '', items,
    totals: computeTotals(items, small, vatRate), paid_cents: 0, has_signed_doc: false, ...over,
  }
}
